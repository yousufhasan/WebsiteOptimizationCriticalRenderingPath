...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "../dist/img/views/pizzaoptimum.png";
...
var resizePizzas = function(size) {
  ...
  function determineDx (elem, windowWidth, newSize) {
  ...
  function changePizzaSizes(size) {
    ...
    var pizzaElem = allPizzas[0];
    var dx = determineDx(pizzaElem, windowWidth, newSize);
    var newWidth = (pizzaElem.offsetWidth + dx) + 'px';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 1; i <= (rows*cols); i++) {
    ...
    elem.src = "../dist/img/views/pizzaoptimum.png";
